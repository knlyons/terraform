...
func resourceIBMCloudInfraLbVpxService() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbVpxServiceCreate,
		Read:     resourceIBMCloudInfraLbVpxServiceRead,
		Update:   resourceIBMCloudInfraLbVpxServiceUpdate,
		Delete:   resourceIBMCloudInfraLbVpxServiceDelete,
		Exists:   resourceIBMCloudInfraLbVpxServiceExists,
...
func resourceIBMCloudInfraLbVpxServiceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxServiceCreate101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxServiceCreate105(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxServiceRead101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxServiceRead105(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceUpdate(d *schema.ResourceData, meta interface{}) error {
	_, nadcId, _, err := parseServiceId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxServiceUpdate101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxServiceUpdate105(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceDelete(d *schema.ResourceData, meta interface{}) error {
	_, nadcId, _, err := parseServiceId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxServiceDelete101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxServiceDelete105(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	_, nadcId, _, err := parseServiceId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxServiceExists101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxServiceExists105(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceCreate101(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbVpxServiceRead(d, meta)
}

func resourceIBMCloudInfraLbVpxServiceCreate105(d *schema.ResourceData, meta interface{}) error {
	vipId := d.Get("vip_id").(string)
	vipName, nadcId, _, err := parseServiceId(vipId)
	serviceName := d.Get("name").(string)
...
func resourceIBMCloudInfraLbVpxServiceRead101(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbVpxServiceRead105(d *schema.ResourceData, meta interface{}) error {
	vipName, nadcId, serviceName, err := parseServiceId(d.Id())
	if err != nil {
		return fmt.Errorf("Error parsing vip id: %s", err)
	}
...
func resourceIBMCloudInfraLbVpxServiceUpdate101(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbVpxServiceUpdate105(d *schema.ResourceData, meta interface{}) error {
...
func resourceIBMCloudInfraLbVpxServiceDelete101(d *schema.ResourceData, meta interface{}) error {
	vipName, nadcId, serviceName, err := parseServiceId(d.Id())
	if err != nil {
		return fmt.Errorf("Error parsing vip id: %s", err)
	}
...
func resourceIBMCloudInfraLbVpxServiceDelete105(d *schema.ResourceData, meta interface{}) error {
	_, nadcId, serviceName, err := parseServiceId(d.Id())
	if err != nil {
		return fmt.Errorf("Error parsing vip id: %s", err)
	}
...
func resourceIBMCloudInfraLbVpxServiceExists101(d *schema.ResourceData, meta interface{}) (bool, error) {
	vipName, nadcId, serviceName, err := parseServiceId(d.Id())
	if err != nil {
...
func resourceIBMCloudInfraLbVpxServiceExists105(d *schema.ResourceData, meta interface{}) (bool, error) {
	_, nadcId, serviceName, err := parseServiceId(d.Id())
	if err != nil {
		return false, fmt.Errorf("Error parsing vip id: %s", err)
	}
