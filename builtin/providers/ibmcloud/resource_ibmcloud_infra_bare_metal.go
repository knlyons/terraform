...
func resourceIBMCloudInfraBareMetal() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraBareMetalCreate,
		Read:     resourceIBMCloudInfraBareMetalRead,
		Update:   resourceIBMCloudInfraBareMetalUpdate,
		Delete:   resourceIBMCloudInfraBareMetalDelete,
		Exists:   resourceIBMCloudInfraBareMetalExists,
...
func resourceIBMCloudInfraBareMetalCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraBareMetalRead(d, meta)
}

func resourceIBMCloudInfraBareMetalRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceIBMCloudInfraBareMetalUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceIBMCloudInfraBareMetalDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraBareMetalExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	service := services.GetHardwareService(meta.(ClientSession).SoftLayerSession())
