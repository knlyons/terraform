...
func resourceIBMCloudInfraSecurityCertificate() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraSecurityCertificateCreate,
		Read:     resourceIBMCloudInfraSecurityCertificateRead,
		Delete:   resourceIBMCloudInfraSecurityCertificateDelete,
		Exists:   resourceIBMCloudInfraSecurityCertificateExists,
...
func resourceIBMCloudInfraSecurityCertificateCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraSecurityCertificateRead(d, meta)
}

func resourceIBMCloudInfraSecurityCertificateRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetSecurityCertificateService(sess)
...
func resourceIBMCloudInfraSecurityCertificateDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetSecurityCertificateService(sess)
...
func resourceIBMCloudInfraSecurityCertificateExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetSecurityCertificateService(sess)
