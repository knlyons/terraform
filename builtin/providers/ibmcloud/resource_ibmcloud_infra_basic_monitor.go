...
func resourceIBMCloudInfraBasicMonitor() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraBasicMonitorCreate,
		Read:     resourceIBMCloudInfraBasicMonitorRead,
		Update:   resourceIBMCloudInfraBasicMonitorUpdate,
		Delete:   resourceIBMCloudInfraBasicMonitorDelete,
		Exists:   resourceIBMCloudInfraBasicMonitorExists,
...
func resourceIBMCloudInfraBasicMonitorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraBasicMonitorRead(d, meta)
}
...
func resourceIBMCloudInfraBasicMonitorRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraBasicMonitorUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkMonitorVersion1QueryHostService(sess)
...
func resourceIBMCloudInfraBasicMonitorDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkMonitorVersion1QueryHostService(sess)
...
func resourceIBMCloudInfraBasicMonitorExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkMonitorVersion1QueryHostService(sess)
