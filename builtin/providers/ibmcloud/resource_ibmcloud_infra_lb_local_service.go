...
func resourceIBMCloudInfraLbLocalService() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbLocalServiceCreate,
		Read:     resourceIBMCloudInfraLbLocalServiceRead,
		Update:   resourceIBMCloudInfraLbLocalServiceUpdate,
		Delete:   resourceIBMCloudInfraLbLocalServiceDelete,
		Exists:   resourceIBMCloudInfraLbLocalServiceExists,
...
func resourceIBMCloudInfraLbLocalServiceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbLocalServiceRead(d, meta)
}

func resourceIBMCloudInfraLbLocalServiceUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
