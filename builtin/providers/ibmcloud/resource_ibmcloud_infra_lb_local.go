...
func resourceIBMCloudInfraLbLocal() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbLocalCreate,
		Read:     resourceIBMCloudInfraLbLocalRead,
		Update:   resourceIBMCloudInfraLbLocalUpdate,
		Delete:   resourceIBMCloudInfraLbLocalDelete,
		Exists:   resourceIBMCloudInfraLbLocalExists,
...
func resourceIBMCloudInfraLbLocalCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbLocalUpdate(d, meta)
}

func resourceIBMCloudInfraLbLocalUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	...
	return resourceIBMCloudInfraLbLocalRead(d, meta)
}

func resourceIBMCloudInfraLbLocalRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
