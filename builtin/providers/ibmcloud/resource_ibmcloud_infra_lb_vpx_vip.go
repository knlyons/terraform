...
func resourceIBMCloudInfraLbVpxVip() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbVpxVipCreate,
		Read:     resourceIBMCloudInfraLbVpxVipRead,
		Update:   resourceIBMCloudInfraLbVpxVipUpdate,
		Delete:   resourceIBMCloudInfraLbVpxVipDelete,
		Exists:   resourceIBMCloudInfraLbVpxVipExists,
...
func resourceIBMCloudInfraLbVpxVipCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxVipCreate101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxVipCreate105(d, meta)
}

func resourceIBMCloudInfraLbVpxVipRead(d *schema.ResourceData, meta interface{}) error {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxVipRead101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxVipRead105(d, meta)
}

func resourceIBMCloudInfraLbVpxVipUpdate(d *schema.ResourceData, meta interface{}) error {
	nadcId, _, err := parseId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxVipUpdate101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxVipUpdate105(d, meta)
}

func resourceIBMCloudInfraLbVpxVipDelete(d *schema.ResourceData, meta interface{}) error {
	nadcId, _, err := parseId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxVipDelete101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxVipDelete105(d, meta)
}

func resourceIBMCloudInfraLbVpxVipExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	nadcId, _, err := parseId(d.Id())
	if err != nil {
	...
	if version == VPX_VERSION_10_1 {
		return resourceIBMCloudInfraLbVpxVipExists101(d, meta)
	}

	return resourceIBMCloudInfraLbVpxVipExists105(d, meta)
}
...
func resourceIBMCloudInfraLbVpxVipCreate101(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbVpxVipRead(d, meta)
}

func resourceIBMCloudInfraLbVpxVipCreate105(d *schema.ResourceData, meta interface{}) error {
	nadcId := d.Get("nad_controller_id").(int)
	...
	if vipType == "SSL" {
		...
		if err != nil {
			...
			resourceIBMCloudInfraLbVpxVipDelete105(d, meta)
			return err
		}
	}
...
func resourceIBMCloudInfraLbVpxVipRead101(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()

	nadcId, vipName, err := parseId(d.Id())
	if err != nil {
		return fmt.Errorf("ibmcloud_infra_lb_vpx : %s", err)
	}

	vip, err := network.GetNadcLbVipByName(sess, nadcId, vipName)
	if err != nil {
		return fmt.Errorf("ibmcloud_infra_lb_vpx : while looking up a virtual ip address : %s", err)
	}
...
func resourceIBMCloudInfraLbVpxVipRead105(d *schema.ResourceData, meta interface{}) error {
	nadcId, vipName, err := parseId(d.Id())
	if err != nil {
		return fmt.Errorf("ibmcloud_infra_lb_vpx : %s", err)
	}
...
func resourceIBMCloudInfraLbVpxVipUpdate101(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkApplicationDeliveryControllerService(sess)
...
func resourceIBMCloudInfraLbVpxVipUpdate105(d *schema.ResourceData, meta interface{}) error {
	nadcId := d.Get("nad_controller_id").(int)
	nClient, err := getNitroClient(meta.(ClientSession).SoftLayerSession(), nadcId)
	if err != nil {
		return fmt.Errorf("Error getting netscaler information ID: %d", nadcId)
...
func resourceIBMCloudInfraLbVpxVipDelete101(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkApplicationDeliveryControllerService(sess)
...
func resourceIBMCloudInfraLbVpxVipDelete105(d *schema.ResourceData, meta interface{}) error {
	nadcId, vipName, err := parseId(d.Id())
	if err != nil {
		return fmt.Errorf("ibmcloud_infra_lb_vpx : %s", err)
	}
...
func resourceIBMCloudInfraLbVpxVipExists101(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()

	nadcId, vipName, err := parseId(d.Id())
	if err != nil {
		return false, fmt.Errorf("ibmcloud_infra_lb_vpx : %s", err)
	}
