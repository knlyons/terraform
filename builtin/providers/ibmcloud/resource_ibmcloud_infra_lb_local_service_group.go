...
func resourceIBMCloudInfraLbLocalServiceGroup() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbLocalServiceGroupCreate,
		Read:     resourceIBMCloudInfraLbLocalServiceGroupRead,
		Update:   resourceIBMCloudInfraLbLocalServiceGroupUpdate,
		Delete:   resourceIBMCloudInfraLbLocalServiceGroupDelete,
		Exists:   resourceIBMCloudInfraLbLocalServiceGroupExists,
...
func resourceIBMCloudInfraLbLocalServiceGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbLocalServiceGroupRead(d, meta)
}

func resourceIBMCloudInfraLbLocalServiceGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceGroupRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceGroupDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbLocalServiceGroupExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
