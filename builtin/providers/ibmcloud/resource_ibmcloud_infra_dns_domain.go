...
func resourceIBMCloudInfraDNSDomain() *schema.Resource {
	return &schema.Resource{
		Exists:   resourceIBMCloudInfraDNSDomainExists,
		Create:   resourceIBMCloudInfraDNSDomainCreate,
		Read:     resourceIBMCloudInfraDNSDomainRead,
		Update:   resourceIBMCloudInfraDNSDomainUpdate,
		Delete:   resourceIBMCloudInfraDNSDomainDelete,
...
func resourceIBMCloudInfraDNSDomainCreate(d *schema.ResourceData, meta interface{}) error {
	...
	// read remote state
	return resourceIBMCloudInfraDNSDomainRead(d, meta)
}

func resourceIBMCloudInfraDNSDomainRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainService(sess)
...
func resourceIBMCloudInfraDNSDomainUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceIBMCloudInfraDNSDomainDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainService(sess)
...
func resourceIBMCloudInfraDNSDomainExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainService(sess)
