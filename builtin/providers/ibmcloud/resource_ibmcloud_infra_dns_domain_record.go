...
func resourceIBMCloudInfraDNSDomainRecord() *schema.Resource {
	return &schema.Resource{
		Exists:   resourceIBMCloudInfraDNSDomainRecordExists,
		Create:   resourceIBMCloudInfraDNSDomainRecordCreate,
		Read:     resourceIBMCloudInfraDNSDomainRecordRead,
		Update:   resourceIBMCloudInfraDNSDomainRecordUpdate,
		Delete:   resourceIBMCloudInfraDNSDomainRecordDelete,
...
func resourceIBMCloudInfraDNSDomainRecordCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraDNSDomainRecordRead(d, meta)
}
...
func resourceIBMCloudInfraDNSDomainRecordRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainResourceRecordService(sess)
...
func resourceIBMCloudInfraDNSDomainRecordUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraDNSDomainRecordDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainResourceRecordService(sess)
...
func resourceIBMCloudInfraDNSDomainRecordExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetDnsDomainResourceRecordService(sess)
