...
func resourceIBMCloudInfraFwHardwareDedicatedRules() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraFwHardwareDedicatedRulesCreate,
		Read:     resourceIBMCloudInfraFwHardwareDedicatedRulesRead,
		Update:   resourceIBMCloudInfraFwHardwareDedicatedRulesUpdate,
		Delete:   resourceIBMCloudInfraFwHardwareDedicatedRulesDelete,
		Exists:   resourceIBMCloudInfraFwHardwareDedicatedRulesExists,
...
func resourceIBMCloudInfraFwHardwareDedicatedRulesCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraFwHardwareDedicatedRulesRead(d, meta)
}

func resourceIBMCloudInfraFwHardwareDedicatedRulesRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFwHardwareDedicatedRulesUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFwHardwareDedicatedRulesDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	fwId, err := strconv.Atoi(d.Id())
	if err != nil {
		return fmt.Errorf("Not a valid firewall ID, must be an integer: %s", err)
...
func resourceIBMCloudInfraFwHardwareDedicatedRulesExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
