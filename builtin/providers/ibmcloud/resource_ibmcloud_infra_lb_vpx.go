...
func resourceIBMCloudInfraLbVpx() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbVpxCreate,
		Read:     resourceIBMCloudInfraLbVpxRead,
		Delete:   resourceIBMCloudInfraLbVpxDelete,
		Exists:   resourceIBMCloudInfraLbVpxExists,
...
func resourceIBMCloudInfraLbVpxCreate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	...
	return resourceIBMCloudInfraLbVpxRead(d, meta)
}

func resourceIBMCloudInfraLbVpxRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraLbVpxDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkApplicationDeliveryControllerService(sess)
...
func resourceIBMCloudInfraLbVpxExists(d *schema.ResourceData, meta interface{}) (bool, error) {
